...
?>
<form action="register-nopasswd.php" method="POST">
...
if (strcasecmp($_SERVER['REQUEST_METHOD'], 'get') === 0) {
    ...
    if (count($errors) > 0) {
        ...
        file_put_contents(sys_get_temp_dir() . DIRECTORY_SEPARATOR . str_replace([DIRECTORY_SEPARATOR, '/'], '_', $_POST['email']) . '.json', json_encode($_POST));
